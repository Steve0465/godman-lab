...
class ToolRouter:
    ...
    def route(self, plan_step: str) -> Optional[BaseTool]:
        """
        ...
        Returns:
            BaseTool if a match is found, None otherwise
    ...
    def route_multiple(self, plan_steps: List[str]) -> Dict[str, Optional[BaseTool]]:
        """
...
def quick_route(plan_step: str) -> Optional[BaseTool]:
    """
    Quick routing function that creates a router and routes in one call.
    
    Args:
        plan_step: Plan step to route
        
    Returns:
        Matched BaseTool or None
    """
